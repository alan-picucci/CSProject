													...
													if (x[5] <= -5.0) {
														if (x[3] <= -7.0) {
															if (x[2] <= 8.5) {
																...
																if (x[5] <= -7.0) {
																	if (11(+0.0258*x[2]+0*x[3]+0.0184*x[5]-0.999)^2-0.0612(-0.832*x[2]+0.538*x[3]-0.133*x[5]-0.0239)^2+0.0438(-0.308*x[2]-0.65*x[3]-0.695*x[5]-0.0209)^2 <= 0) {
																		return 0.0f;
																	}
																	else {
																		return 0.0f;
														...
														if (x[2] <= 10.5) {
															if (2.21(+0*x[2]-0.0955*x[3]+0.0808*x[5]-0.992)^2-0.0589(+0.235*x[2]-0.941*x[3]+0.218*x[5]+0.108)^2+0.0526(+0.284*x[2]-0.155*x[3]-0.944*x[5]-0.0621)^2 <= 0) {
																return 0.0f;
															}
															else {
																return 0.0f;
