...
from dtcontrol.decision_tree.splitting.polynomial_lowrank import LowRankPolynomialSplit
...
class Node:
    ...
    def fit(self, dataset, **kwargs):
        ...
        #if isinstance(self.split, LowRankPolynomialSplit):
            #print(self.split.get_coef_matrix())
