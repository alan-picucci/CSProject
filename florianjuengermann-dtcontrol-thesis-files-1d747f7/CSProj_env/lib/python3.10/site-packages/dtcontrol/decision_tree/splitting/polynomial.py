...
class PolynomialClassifierSplittingStrategy(SplittingStrategy):
    ...
    def find_split(self, dataset, impurity_measure, **kwargs):
        ...
        for label in labels:
            ...
            splitData = (impurity, split, label_mask, standardizer, svc, label)
        ...
        imp, bestSplit, label_mask, standardizer, svc, best_label = min(
            splits, key=lambda t: t[0])

        print("Best impurity of polynomial split from label: ", best_label," with impurity ",imp)
